...
// SqliteBlob serves index documents from sqlite database with a fixed schema,
...
// SolrBlob fetches index data actually from a SOLR index. The base url would
// be something like http://localhost/solr/biblio (e.g. without the select part
// of the path).
