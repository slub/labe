        ...
        data = {
            ...
            "institution": {
                self.institution: {
                    ...
                    "ratio_common_exp": (sum(1 for _ in si.get("common_institution").open()) / sum(1 for _ in si.get("exp_unique").open())),
                },
            },
            "index": {
                ...
                "ratio_common_exp": (sum(1 for _ in si.get("common").open()) / sum(1 for _ in si.get("exp_unique").open())),
            },
            "exp": {
